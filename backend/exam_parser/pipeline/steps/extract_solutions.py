"""Extract solution PDFs to markdown with local Nougat (GPU/CPU)."""
...
async def run(
    ...
    """Process solution PDFs sequentially (one PDF at a time)."""
    try:
        ...
        for pdf in pending:
            ...
            await _extract_one(pdf, dirs.solutions_vision, checkpoint, logger)
